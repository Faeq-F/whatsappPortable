...
- "Minimize window on startup" setting

### Fixed

- Race condition where WebViewControllers were accessed before initialization on application startup
...
[2.4.1]: https://github.com/Faeq-F/whatsappPortable/compare/Version2.4.0...Version2.4.1
